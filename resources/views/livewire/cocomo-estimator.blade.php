<div class="container mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="mb-8 border-b border-gray-200 dark:border-gray-700">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            <button wire:click="showCalculator"
                class="{{ $activeTab === 'calculator' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-200' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Calculadora
            </button>
            <button wire:click="showEstimations"
                class="{{ $activeTab === 'estimations' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-200' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Estimaciones Guardadas
                <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-100">
                    {{ $savedEstimations->count() }}
                </span>
            </button>
        </nav>
    </div>
    ...
    @if ($activeTab === 'calculator')
        {{-- CONTENIDO DE LA PESTAÑA DE LA CALCULADORA --}}
        <div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="projectName" wire:model="projectName" placeholder="Ej: Sistema de inventario"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white dark:bg-gray-700">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-2 mb-4 flex justify-between items-center">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                VL: Muy Bajo, L: Bajo, N: Nominal, H: Alto, VH: Muy Alto, XH: Extra Alto
                            </p>
                            @endif
                        </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            <input id="useTwoDecimalRounding" type="checkbox" wire:model.live="useTwoDecimalRounding"
                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            <label for="useTwoDecimalRounding" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                                Usar 2 decimales
                            </label>
                        </div>
    ...
    @if ($activeTab === 'estimations')
        {{-- CONTENIDO DE LA PESTAÑA DE ESTIMACIONES GUARDADAS --}}
        <div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button wire:click="delete({{ $estimation->id }})" wire:confirm="¿Estás seguro de que quieres eliminar esta estimación?"
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                No hay estimaciones guardadas todavía.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
